@page desktop_chrome_and_pointer_input Custom chrome and pointer input
...
The optional @ref desktop_renderer_integration bridge stores one bit per physical framebuffer pixel. A zero bit passes input through; a one bit accepts
...
otherwise remain separate surfaces. See @ref desktop_custom_cursors for selection and restoration behavior.
