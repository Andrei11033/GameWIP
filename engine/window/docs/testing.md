...
Automated tests keep native windows hidden. Visible behavior, genuine cross-application pointer routing, real focus arbitration, shell visuals, drag/drop gestures, DPI transitions across physical monitors, actual monitor disconnect/reconnect, transparent renderer output, and exclusive display restoration need the scenarios in @ref window_manual_validation.
