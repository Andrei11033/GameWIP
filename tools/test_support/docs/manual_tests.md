...
Automated tests should not depend on clicking dialogs. Applications decide how manual checks are enabled and selected; GameWIP's command-line integration is documented in @ref project_testing.
