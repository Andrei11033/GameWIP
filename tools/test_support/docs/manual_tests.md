...
Manual checks are for behavior code cannot verify on its own, such as visual Windows UI behavior or debugger interaction. They must be gated by runtime options and should run near the end of a test run.
