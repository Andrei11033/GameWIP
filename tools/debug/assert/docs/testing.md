...
Coverage is enabled with `GAMEWIP_ENABLE_COVERAGE=ON` and generated by the project-level `coverage` target. See @ref library_coverage. gcov/gcovr may warn about ignored negative hits while still generating HTML and XML reports.
