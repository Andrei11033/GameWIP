...
namespace GameWIP::Debug::Assert::TestHooks
{
    ...
    INTERNAL_ASSERT_API void reset() noexcept;
    ...
    INTERNAL_ASSERT_API void forceNextActionDialogFailure() noexcept;
    ...
    INTERNAL_ASSERT_API void forceNextFallbackActionDialogFailure() noexcept;
    ...
    INTERNAL_ASSERT_API void setDebuggerAttachedOverride(bool attached) noexcept;

    /// @brief Clears the debugger-attached override.
    /// @warning Test-only API.
    INTERNAL_ASSERT_API void clearDebuggerAttachedOverride() noexcept;
    ...
    INTERNAL_ASSERT_API void setPopupSuppressedOverride(bool suppressed) noexcept;

    /// @brief Clears the popup-suppression override.
    /// @warning Test-only API.
    INTERNAL_ASSERT_API void clearPopupSuppressedOverride() noexcept;
    ...
    /// @warning Test-only API. Available only when INTERNAL_ASSERT_TEST_HOOKS is enabled.
    INTERNAL_ASSERT_API bool debuggerAttachedForTest() noexcept;
    ...
    /// @warning Test-only API. Available only when INTERNAL_ASSERT_TEST_HOOKS is enabled.
    INTERNAL_ASSERT_API FailureAction
    ...
    /// @warning Test-only API. Available only when INTERNAL_ASSERT_TEST_HOOKS is enabled.
    INTERNAL_ASSERT_API void showErrorPopupForTest(std::string_view title, std::string_view message) noexcept;
...
namespace GameWIP::Debug::Assert::Detail::TestHooks
{
    ...
    INTERNAL_ASSERT_API bool consumeNextActionDialogFailure() noexcept;
    /// @brief Consumes the one-shot fallback action-dialog failure hook.
    INTERNAL_ASSERT_API bool consumeNextFallbackActionDialogFailure() noexcept;
    /// @brief Reads the debugger-attached override when one is active.
    INTERNAL_ASSERT_API bool debuggerAttachedOverride(bool &attached) noexcept;
    /// @brief Reads the popup-suppressed override when one is active.
    INTERNAL_ASSERT_API bool popupSuppressedOverride(bool &suppressed) noexcept;
} // namespace GameWIP::Debug::Assert::Detail::TestHooks
#endif
