...
Color and style behavior is documented in @ref foundation_terminal_styling.

Stream kind, capability detection, and redirection behavior are documented in @ref foundation_terminal_capabilities_and_redirection.
