...
function Show-GameWipHelp
{
    ...
    Write-Host '  test [preset] [-NoBuild]'
    ...
    Write-Host '  -NonInteractive   Never prompt. This does not grant consent.'
    Write-Host '  -Yes              Grant consent after the operation plan is known.'
    Write-Host '  -NoBuild          Do not auto-build missing prerequisites.'
