...
void testClipboardRoundTrips(TestSupport::Context &context)
{
    ...
    static_cast<void>(context.expectEq("image dimensions round trip", Window::Types::PixelSize{2, 2}, imageRead.image.size));
...
void testClipboardMultiFormatAndFailures(TestSupport::Context &context)
{
    ...
    Window::TestHooks::failNext(Window::TestHooks::FailurePoint::ClipboardAllocation);
    ...
    Window::TestHooks::failNext(Window::TestHooks::FailurePoint::ClipboardOwnerCreation);
    ...
    Window::TestHooks::failClipboardEnumerationAfter(1);
    ...
    Window::TestHooks::failNext(Window::TestHooks::FailurePoint::ClipboardRead);
    static_cast<void>(context.expectEq("native read failure translates", ErrorCode::ReadFailed, Clipboard::readText().status.code));

    Window::TestHooks::failNext(Window::TestHooks::FailurePoint::ClipboardClear);
    ...
    Window::TestHooks::failClipboardPublicationAt(0);
    ...
    Window::TestHooks::failClipboardPublicationAt(2);
    ...
    Window::TestHooks::failNext(Window::TestHooks::FailurePoint::ClipboardClose);
