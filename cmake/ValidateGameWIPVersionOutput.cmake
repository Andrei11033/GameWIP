...
gamewip_detect_version(expected SOURCE_DIR "${SOURCE_DIR}" PROJECT_VERSION "${PROJECT_VERSION_VALUE}")
...
if(NOT version_result EQUAL 0)
    message(FATAL_ERROR "GameWIP --version failed with exit code ${version_result}.\n" "stdout:\n${version_output}\n" "stderr:\n${version_error}")
endif()

set(expected_output "GameWIP ${expected_DISPLAY}")
if(NOT version_output STREQUAL expected_output)
    message(FATAL_ERROR "GameWIP --version output mismatch.\n" "Expected: ${expected_output}\n" "Actual:   ${version_output}")
endif()
