...
function(gamewip_resolve_platform_id output_variable)
    ...
    elseif(UNIX)
        ...
        message(FATAL_ERROR "No GameWIP platform backend id is defined for this CMake platform.")
    endif()

    set(GAMEWIP_PLATFORM_ID "${resolved_platform_id}" CACHE STRING "GameWIP platform backend id")
